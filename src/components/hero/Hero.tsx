...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative isolate flex min-h-[88svh] items-center overflow-hidden bg-background py-16 sm:py-20 lg:min-h-[92svh] lg:py-0"
    >
      <HeroBackdrop />
      ...
      <div className="relative mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-14 px-5 sm:px-8 lg:grid-cols-[45fr_55fr] lg:gap-10 lg:px-10">
        ...
        <div className="max-w-xl animate-rise">
          <p className="inline-flex items-center gap-2 rounded-full border border-border/70 bg-card/70 px-4 py-1.5 text-[0.68rem] font-semibold uppercase tracking-[0.22em] text-primary backdrop-blur-sm">
            <Sparkles className="h-3.5 w-3.5 text-accent-deep" aria-hidden="true" />
            Personalized Hormone &amp; Wellness Care
          </p>
          ...
          >
            ...
            Live Better.
            <br />
            <span className="text-gradient-accent font-normal italic">Be Your Best.</span>
          </h1>

          <p className="mt-7 max-w-md text-base leading-relaxed text-muted-foreground sm:text-lg">
            Personalized programs designed around your health, your goals, and your journey.
          </p>

          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:items-center">
            <a
              href="https://royalmedicalcenters.com/contact/#form"
              className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary px-8 py-4 text-sm font-semibold tracking-wide text-primary-foreground shadow-[var(--shadow-cta)] transition-all duration-300 hover:-translate-y-0.5 hover:bg-primary-soft hover:shadow-[var(--shadow-cta-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
            >
              Get Started
              <ArrowRight
          ...
          <div className="mt-10 flex items-center gap-4 border-t border-border/70 pt-6">
            <span className="h-9 w-px bg-gradient-to-b from-transparent via-accent to-transparent" />
            <p className="text-sm text-muted-foreground">
              <span className="block text-[0.66rem] font-semibold uppercase tracking-[0.2em] text-primary">
