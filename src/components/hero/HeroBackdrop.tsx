  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, color-mix(in oklab, var(--primary-glow) 34%, transparent), transparent 68%)",
        }}
      />
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, color-mix(in oklab, var(--accent) 26%, transparent), transparent 70%)",
        }}
      />
      ...
      >
        ...
        />
        <g stroke="var(--primary)" strokeOpacity="0.07" fill="none" strokeWidth="1">
      ...
      {[
        ...
        <span
          key={i}
          className="absolute rounded-full bg-primary-soft/35 animate-drift motion-reduce:animate-none"
          style={{
            left: p.l,
            top: p.t,
            width: p.s,
